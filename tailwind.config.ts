  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'emergency-gradient': 'linear-gradient(135deg, hsl(var(--emergency-red)) 0%, hsl(var(--emergency-orange)) 100%)',
        'hero-gradient': 'linear-gradient(135deg, hsl(var(--emergency-blue)) 0%, hsl(var(--emergency-red)) 50%, hsl(var(--emergency-orange)) 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
